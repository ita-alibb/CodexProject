...
/**
 * TestConnectionRMI, used for test, does not forward the broadcast message
 */
public class TestConnectionRMI extends UnicastRemoteObject implements RemoteConnection, Connection {

    private static TestConnectionRMI INSTANCE;
     ...
     */
    public TestConnectionRMI() throws RemoteException {
        try {
    ...
    public void sendMessage(BaseResponseData response) throws RemoteException {
        ...
        /* Do not use ViewModelState in test connection
